...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=512,
        help="The maximum total sequence length of each training example.",
    )
    parser.add_argument(
...
def encode_autoregressive(example, tokenizer, max_seq_length):
    '''
    Here we assume each example has a 'text' field 
    '''
...
def main():
    ...
    if args.with_tracking:
        ...
        accelerator.init_trackers(
            project_name="onesignal_lm_ft", 
            config={"lr": args.learning_rate}
            init_kwargs={"wandb": {"entity": "voyage"}}
            )
